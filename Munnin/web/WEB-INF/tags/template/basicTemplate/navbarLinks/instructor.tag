...
<li ${actualPage==3 ? "class='active'":""}><a href="${pageContext.request.contextPath}/home/role/instructor/search.jsp" >Buscar</a></li>
<li ${actualPage==4 ? "class='active'":""}><a href="${pageContext.request.contextPath}/home/role/instructor/mystuff.jsp"  >Mi material</a></li>