...
<div id="disabledCategories" class="modal fade" role="dialog">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form id="formSearchCategoriesEnable" 
                              ...
                              method="POST" 
                              action="${pageContext.request.contextPath}/home/role/coordinator/categories/refresh-disabled-categories"
                              data-ajax-form="true"
    ...
    <form id="formEnableCategories"
          method="POST"
          action="${pageContext.request.contextPath}/home/role/coordinator/categories/enable-categories"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            ajaxLoadContent("${pageContext.request.contextPath}/home/role/coordinator/categories/refresh-disabled-categories", "showDisabledCategoriesTable");
