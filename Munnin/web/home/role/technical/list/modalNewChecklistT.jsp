...
<div class="modal fade" id="modalListT" role="dialog">
    <div class="modal-dialog modal-lg">
        <form id="formCreateList"  
          role="form" 
          method="POST" 
          action="${pageContext.request.contextPath}/home/role/technical/list/create"
          data-display="vacio"
            ...
            <div class="modal-body">
                <div class="container-checklist">
                    <div id="myDIV" class="header">
                        ...
                        <input type="text" id="myInput" placeholder="Nuevo Item..." maxlength="100">
