    ...
    <jsp:attribute name="additionalJS">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ajaxLoadContent("${pageContext.request.contextPath}/home/role/pedagogical/list/search", "fulltable");
            });
        </script>
    </jsp:attribute>
    <jsp:body>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <tables:dataTableSearch id="formSearchCategoriesEnable"
                                                urlServlet="${pageContext.request.contextPath}/home/role/pedagogical/list/search"
        ...
        <tables:dataTableSelectForm id="formActionList"
                                    ...
                                    urlServlet="${pageContext.request.contextPath}/home/role/pedagogical/list/manage" />
        <jsp:include page="/home/role/pedagogical/list/modalNewChecklistP.jsp" />
    </jsp:body>
