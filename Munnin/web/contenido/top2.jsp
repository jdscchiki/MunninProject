...
<ul class="nav navbar-nav navbar-right">
    ...
    <li><a href="salida"><span class="glyphicon glyphicon-log-in"></span> Salir</a></li>
</ul>
</div>
</div>
</nav>
...
<div id="mySidenav" class="sidenav">
    ...
    <a href="roles/administrador/inicio.jsp">Administrador</a>
    <a href="roles/coordinador/inicio.jsp">Coordinador</a>
    <a href="roles/tecnico/inicio.jsp">E. Técnico</a>
    <a href="roles/pedagogico/inicio.jsp">E. Pedagógico</a>
    <a href="roles/instructor/inicio.jsp">Instructor</a>
</div>

<!--left changing_role-->
<div class="left">
    <a href="roles/administrador/inicio.jsp">
        <div class="item">
            <span class="fa fa-eye glyphicon" style="font-size:18px"></span>Administrador
        </div>
    </a>
    <a href="roles/coordinador/inicio.jsp">
        <div class="item active">
            <span class="fa fa-file-o glyphicon" style="font-size:18px"></span>Coordinador
        </div>
    </a>
    <a href="roles/tecnico/inicio.jsp">
        <div class="item">
            <span class="fa fa-group glyphicon" style="font-size:18px"></span>E. Técnico
        </div>
    </a>
    <a href="roles/pedagogico/inicio.jsp">
        <div class="item">
            <span class="fa fa-group glyphicon" style="font-size:18px"></span>E. Pedagógico
        </div>
    </a>
    <a href="roles/instructor/inicio.jsp">
        <div class="item">
