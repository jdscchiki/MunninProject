...
import controller.servlet.home.role.pedagogical.list.*;
 ...
 * @author Monica
 */
@WebServlet(urlPatterns = {"/home/role/technical/list/manage"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (idList <= 0) {
                ...
                switch (opcion) {
                    case "disable":
                        switch (Technical.changeActiveList(idList, false)) {
                            case 0:
