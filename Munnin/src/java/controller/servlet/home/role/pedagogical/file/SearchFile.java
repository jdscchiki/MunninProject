...
public class SearchFile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int totalPages = Coordinator.countPagesFilesCenter(funcionario.getCentro().getId(), cantXpag, search);
            request.setAttribute("page", page);
            request.setAttribute("pages", util.Pager.showLinkedPages(page, totalPages, cantXpag));
            request.setAttribute("contentTable", Coordinator.viewFilesCenter(funcionario.getCentro().getId(), page, cantXpag, search));
