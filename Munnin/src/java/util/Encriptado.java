...
public class Encriptado {
    ...
    private static final int HASH_BYTE_SIZE = 153;//254 es el largo del hash cuando la contraseña es procesada
    //este es el numero que se debe cambiar dependiendo de las caracteristicas del servidor
