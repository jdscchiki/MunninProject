...
public class Mail {
    ...
    private static final String CORREO_DE = "";//poner un correo con los permisos
    private static final String NOMBRE_DE = "Munnin";
    private static final String USUARIO = "";//poner un usuario con los permisos, en gmail es el mismo correo
    private static final String CONTRASENA = "";//contraseña del correo
    ...
    /**
     * Metodo dedicado al envio de correos con la contraseña para ingresar a la plataforma
     * 
