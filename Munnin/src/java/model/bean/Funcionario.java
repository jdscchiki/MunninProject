...
public class Funcionario implements java.io.Serializable {
    ...
    public boolean isAdministrador() {
        for (Rol rol : roles) {
            if (rol.getId() == model.dao.RolDAO.ID_ADMINISTRADOR) {
                return true;
            }
        }
        return false;
    ...
    public boolean isCoordinador() {
        for (Rol rol : roles) {
            if (rol.getId() == model.dao.RolDAO.ID_COORDINADOR) {
                return true;
            }
        }
        return false;
    ...
    public boolean isTecnico() {
        for (Rol rol : roles) {
            if (rol.getId() == model.dao.RolDAO.ID_E_TECNICO) {
                return true;
            }
        }
        return false;
    ...
    public boolean isPedagogico() {
        for (Rol rol : roles) {
            if (rol.getId() == model.dao.RolDAO.ID_E_PEDAGOGICO) {
                return true;
            }
        }
        return false;
    ...
    public boolean isInstructor() {
        for (Rol rol : roles) {
            if (rol.getId() == model.dao.RolDAO.ID_INSTRUCTOR) {
                return true;
            }
        }
        return false;
