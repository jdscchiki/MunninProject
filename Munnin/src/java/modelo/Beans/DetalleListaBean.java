 ...
 * @author Juan David
 */
public class DetalleListaBean {
    
    private long id_detalle_lista;
    private long id_lista_detalle_lista;
    private long id_item_detalle_lista;

    public DetalleListaBean() {
    }

    public DetalleListaBean(long id_detalle_lista, long id_lista_detalle_lista, long id_item_detalle_lista) {
