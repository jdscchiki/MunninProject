...
public class Producto_Bean {
    ...
    public Producto_Bean() {
    }

    public Producto_Bean(long id_producto, String nombre_producto, String descripcion_producto, String palabras_clave_producto, long id_tipo_objeto_aprendizaje_producto) {
