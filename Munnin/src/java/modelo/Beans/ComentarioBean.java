...
public class ComentarioBean {
    ...
    public ComentarioBean(long id_comentario, String valoracion_comentario, int puntuacion_comentario, Date fecha_comentario, long id_producto_comentario, long id_funcionario_comentario) {
