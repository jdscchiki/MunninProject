 ...
 * @author Juan David
 */
public class EvalVersionGeneralBean {
    ...
    public EvalVersionGeneralBean() {
    }

    public EvalVersionGeneralBean(long id_eval_version_general, long id_version_eval_version_general, long id_lista_eval_version_general, int calificacion_eval_version_general, String observaciones_eval_version_general, Date fecha_eval_version_general, long id_evaluador_eval_version_general) {
