 ...
 * @author Juan David
 */
public class EvalDetalleListaBean {
    ...
    public EvalDetalleListaBean() {
    }

    public EvalDetalleListaBean(long id_eval_detalle_lista, int calificacion_eval_detalle_lista, String observarcion_eval_detalle_lista, long id_eval_version_general_eval_detalle_lista, long id_detalle_lista_eval_detalle_lista) {
