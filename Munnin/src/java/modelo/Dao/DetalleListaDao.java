...
import modelo.Beans.DetalleListaBean;
 ...
 */
 public class DetalleListaDao extends ConexionBD {
     ...
     */
    public boolean InsertarDetalleLista(DetalleListaBean detalle) throws SQLException {
     ...
     * @throws java.sql.SQLException
     */
    public boolean UpdateArea(DetalleListaBean detalle) throws SQLException {
         boolean resultado;// esta es la futura respuesta
     ...
     * @throws java.sql.SQLException
     */
    public boolean DeleteArea(DetalleListaBean detalle) throws SQLException {
        boolean resultado;// esta es la futura respuesta
