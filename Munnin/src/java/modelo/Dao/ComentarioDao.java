...
import modelo.Beans.ComentarioBean;
...
public class ComentarioDao extends ConexionBD  {
     ...
     */
    public boolean InsertarComentario(ComentarioBean comentario) throws SQLException {
     ...
     * @throws java.sql.SQLException
     */
    public boolean UpdateComentario(ComentarioBean comentario) throws SQLException {
        boolean resultado;//esta es la futura respuesta
     ...
     * @throws java.sql.SQLException
     */
    public boolean DeleteComentario(ComentarioBean comentario) throws SQLException {
        boolean resultado;//esta es la futura respuesta
