...
public class ItemDao extends ConexionBD {
     ...
     */
    public boolean InsertarItem(ItemBean item) throws SQLException {
     ...
     * @throws java.sql.SQLException
     */
    public boolean UpdateItem(ItemBean item) throws SQLException {
        boolean resultado;// esta sera la futura repuesta
     ...
     * @throws java.sql.SQLException
     */
    public boolean DeleteItem(ItemBean item) throws SQLException {
         boolean resultado;// esta sera la futura repuesta
