 ...
 */
public class AutorDao extends ConexionBD {
     ...
     * @throws SQLException
     */
    public AutorDao() throws NamingException, SQLException {
        super();
    }
     ...
     */
    public boolean InsertarAutor(AutorBean autor) throws SQLException {
     ...
     * @throws java.sql.SQLException
     */
    public boolean UpdateAutor(AutorBean autor) throws SQLException {
       boolean resultado;//esta es la futura respuesta
     ...
     * @throws java.sql.SQLException
     */
    public boolean DeleteAutor(AutorBean autor) throws SQLException {
        boolean resultado;//esta es la futura respuesta
