...
import modelo.Beans.TipoObjetoAprendizajeBean;
...
public class TipoObjetoAprendizajeDao extends ConexionBD {
     ...
     */
    public boolean InsertarArea(TipoObjetoAprendizajeBean tipoObjeto) throws SQLException {
     ...
     * @throws java.sql.SQLException
     */
    public boolean UpdateArea(TipoObjetoAprendizajeBean tipoObjeto) throws SQLException {
       boolean resultado; // esta es la futura respuesta
     ...
     * @throws java.sql.SQLException
     */
    public boolean DeleteArea(TipoObjetoAprendizajeBean tipoObjeto) throws SQLException {
        boolean resultado; // esta es la futura respuesta
