...
import modelo.Beans.CentroBean;
...
public class CentroDao extends ConexionBD{ 
     ...
     */
    public boolean InsertarCentro(CentroBean centro) throws SQLException {
     ...
     * @throws java.sql.SQLException
     */
    public boolean UpdateCentro(CentroBean centro) throws SQLException {
         boolean resultado; //esta es la futura respuesta
     ...
     * @throws java.sql.SQLException
     */
    public boolean DeleteCentro(CentroBean centro) throws SQLException {
        boolean resultado; //esta es la futura respuesta
