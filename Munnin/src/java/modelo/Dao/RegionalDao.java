...
import modelo.Beans.RegionalBean;
...
public class RegionalDao extends ConexionBD {
     ...
     */
    public boolean InsertarRegional(RegionalBean regional) throws SQLException {
     ...
     * @throws java.sql.SQLException
     */
    public boolean UpdateRegional(RegionalBean regional) throws SQLException {
       boolean resultado;// esta es la futura respuesta
     ...
     * @throws java.sql.SQLException
     */
    public boolean DeleteRegional(RegionalBean regional) throws SQLException {
        boolean resultado;// esta es la futura respuesta
