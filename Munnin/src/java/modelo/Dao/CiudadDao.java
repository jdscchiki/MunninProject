...
import modelo.Beans.CiudadBean;
...
public class CiudadDao extends ConexionBD{ 
     ...
     */
    public boolean InsertarCiudadl(CiudadBean ciudad) throws SQLException {
     ...
     * @throws java.sql.SQLException
     */
    public boolean UpdateCiudad(CiudadBean ciudad) throws SQLException {
        boolean resultado;//  es la futura respuesta
     ...
     * @throws java.sql.SQLException
     */
    public boolean DeleteCiudad(CiudadBean ciudad) throws SQLException {
        boolean resultado;//  es la futura respuesta
