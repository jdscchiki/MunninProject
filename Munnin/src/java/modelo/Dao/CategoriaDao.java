...
public class CategoriaDao extends ConexionBD{ 
     ...
     */
    public boolean InsertarCategoria(CategoriaBean categoria) throws SQLException {
     ...
     * @throws java.sql.SQLException
     */
    public boolean UpdateCategoria(CategoriaBean categoria) throws SQLException {
        boolean resultado;//esta es la futura respuesta
     ...
     * @throws java.sql.SQLException
     */
    public boolean DeleteCategoria(CategoriaBean categoria) throws SQLException {
        boolean resultado;//esta es la futura respuesta
