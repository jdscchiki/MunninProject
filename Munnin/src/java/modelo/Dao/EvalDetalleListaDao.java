...
import modelo.Beans.EvalDetalleListaBean;
...
public class EvalDetalleListaDao extends ConexionBD {
     ...
     * @throws SQLException
     */
    public EvalDetalleListaDao() throws NamingException, SQLException {
        super();
    }
     ...
     */
    public boolean InsertarEvalDetalleLista(EvalDetalleListaBean detalle) throws SQLException {
     ...
     * @throws java.sql.SQLException
     */
    public boolean UpdateArea(EvalDetalleListaBean detalle) throws SQLException {
       boolean resultado;//esta es la futura respuesta
     ...
     * @throws java.sql.SQLException
     */
    public boolean DeleteArea(EvalDetalleListaBean detalle) throws SQLException {
        boolean resultado;//esta es la futura respuesta
