 ...
 */
@WebFilter(filterName = "SessionFilter", urlPatterns = {"/faces/home/*"})
public class SessionFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (loggedInUser == null || loggedInUser.getFuncionario() == null) {
                //deberia cambiar la respuesta para cuando es una solicitud ajax
                if ("XMLHttpRequest".equals(httpRequest.getHeader("X-Requested-With"))) {
                    httpResponse.sendRedirect(((HttpServletRequest) request).getContextPath() + "/faces/sessionTimeOut.xhtml");
                } else {
